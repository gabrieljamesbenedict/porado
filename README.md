...
Porado is a simple programming language that takes the traditional syntax inspired from the C family of programming languages and blends it with natural English speech to achieve code that is both intuitive and effective.
